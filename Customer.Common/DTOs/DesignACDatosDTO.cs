...
namespace Customer.Common.DTOs
{
    public class DesignACDatosDTO
    {
        ...
        public int? ActuacionTorresId { get; set; }

        public List<TipoSiNo> ActuacionTorres { get; set; }
        ...
        public List<TipoSiNo> NecesarioAdecuacion { get; set; }
